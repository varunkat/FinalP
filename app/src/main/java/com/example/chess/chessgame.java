...
import java.util.ArrayList;
    ...
    public class chessgame extends AppCompatActivity implements View.OnClickListener {
        ...
        public Position[][] Board2;
        public Boolean AnythingSelected ;
        public Coordinates lastPos ;
        public Coordinates clickedPosition;
        public TextView game_over;
        public TextView[][] DisplayBoard;
        public TextView[][] DisplayBoardBackground;
        public ArrayList<Position[][]> LastMoves;
                ...
                for (int j = 0; j < 8; j++) {
                    ...
                    if (Board[i][j].getPiece() != null) {
                        ...
                        switch (x) {
                            case 0:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_king);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_king);
                                }
                                break;

                            case 1:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_queen);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_queen);
                                }
                                break;

                            case 2:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_rook);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_rook);
                                }
                                break;

                            case 3:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_bishop);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_bishop);
                                }
                                break;

                            case 4:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_knight);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_knight);
                                }
                                break;

                            case 5:
                                if (p.isWhite()) {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_white_pawn);
                                } else {
                                    DisplayBoard[i][j].setBackgroundResource(R.drawable.chess_black_pawn);
                                }
                                break;
            ...
            if (!AnythingSelected) {
                if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null) {
                    ...
                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                        ...
                        DisplayBoardBackground[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.color.chess_colorSelected);
        ...
        public void undo(View v){
            if(numberOfMoves>0) {
                ...
                for(int i=0;i<8;i++){
                    for(int j=0;j<8;j++){
                        if((i+j)%2==0){
                            DisplayBoardBackground[i][j].setBackgroundResource(R.color.chess_colorBoardDark);
                        }else{
                            DisplayBoardBackground[i][j].setBackgroundResource(R.color.chess_colorBoardLight);
                        }
                    }
                }
                isKingInDanger();
            ...
            switch (x){
                case R.id.pawn_queen :
                    if(clickedPosition.getY() == 0){
                        ...
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_white_queen);
                    }else{
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Queen(false));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_black_queen);
                    }
                    break;
                case R.id.pawn_rook :
                    if(clickedPosition.getY() == 0){
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Rook(true));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_white_rook);
                    }else{
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Rook(false));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_black_rook);
                    }
                    break;
                case R.id.pawn_bishop :
                    if(clickedPosition.getY() == 0){
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Bishop(true));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_white_bishop);
                    }else{
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Bishop(false));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_black_bishop);
                    }
                    break;
                case R.id.pawn_knight :
                    if(clickedPosition.getY() == 0){
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Knight(true));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_white_knight);
                    }else{
                        Board[clickedPosition.getX()][clickedPosition.getY()].setPiece(new Knight(false));
                        DisplayBoard[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.drawable.chess_black_knight);
        ...
        private void resetColorAtAllowedPosition(ArrayList<Coordinates> listOfCoordinates) {
            for(int i=0; i<listOfCoordinates.size(); i++){
                if((listOfCoordinates.get(i).getX() + listOfCoordinates.get(i).getY())%2==0){
                    DisplayBoardBackground[listOfCoordinates.get(i).getX()][listOfCoordinates.get(i).getY()].setBackgroundResource(R.color.chess_colorBoardDark);
                }else {
                    DisplayBoardBackground[listOfCoordinates.get(i).getX()][listOfCoordinates.get(i).getY()].setBackgroundResource(R.color.chess_colorBoardLight);
                }
            }
        }
        ...
        void setColorAtAllowedPosition(ArrayList<Coordinates> list){
            ...
            for(int i=0; i<list.size(); i++){
                if(Board[list.get(i).getX()][list.get(i).getY()].getPiece() == null){
                    DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.chess_colorPositionAvailable);
                }else{
                    DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.chess_colorDanger);
                }
            }
        }
        ...
        private void resetColorAtLastPosition(Coordinates lastPos){
            if((lastPos.getX() + lastPos.getY())%2==0){
                DisplayBoardBackground[lastPos.getX()][lastPos.getY()].setBackgroundResource(R.color.chess_colorBoardDark);
            }else {
                DisplayBoardBackground[lastPos.getX()][lastPos.getY()].setBackgroundResource(R.color.chess_colorBoardLight);
            }
        }
                        ...
                        for (int x=0;x<List.size();x++){
                            if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof King){
                                ...
                                if((List.get(x).getX()+List.get(x).getY())%2==0){
                                    DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource(R.color.chess_colorBoardDark);
                                }else{
                                    DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource(R.color.chess_colorBoardLight);
                                }

                                if(Board[i][j].getPiece().isWhite() != Board[List.get(x).getX()][List.get(x).getY()].getPiece().isWhite()){
                                    DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource(R.color.chess_colorKingInDanger);
                                }
                            }
                        }
                    }
